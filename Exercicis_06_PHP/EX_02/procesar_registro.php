...
try {
    ...
    $crearTablaSQL = "CREATE TABLE IF NOT EXISTS usuarisImg (
...
// Obtener los datos del formulario de registro
    ...
    // Manejo de la imagen
    $imagen_dir = "./"; // Directorio donde se guardarán las imágenes
    ...
    $stmt = $conexion->prepare("SELECT COUNT(*) FROM usuarisImg WHERE correo = ?");
    ...
    if ($rowCount == 0) {
        ...
        $stmt = $conexion->prepare("INSERT INTO usuarisImg (nombre, correo, contrasena, fecha_nacimiento, es_administrador, imagen) VALUES (?, ?, ?, ?, ?, ?)");
